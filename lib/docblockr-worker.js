...
class DocBlockrAtom {
    ...
    constructor() {
      ...
      atom.config.observe('docblockr', () => this.updateConfig());
      ...
      atom.commands.add('atom-workspace', 'docblockr:parse-enter', (event) => {
        ...
        else if((this.editor_settings.extend_double_slash == true) && (this.validateRequest({preceding:true, preceding_regex:regex.extend_line, scope:'comment.line'}))) {
