var Parsers = {
  JsParser: require("./parser/javascript"),
  CppParser: require("./parser/cpp"),
  RustParser: require("./parser/rust"),
  PhpParser: require("./parser/php"),
  CoffeeParser: require("./parser/coffee"),
  ActionscriptParser: require("./parser/actionscript"),
  ObjCParser: require("./parser/objc"),
  JavaParser: require("./parser/java"),
  TypescriptParser: require("./parser/typescript"),
};
