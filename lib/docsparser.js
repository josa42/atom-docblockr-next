...
DocsParser.prototype.isExistingComment = function(line) {
    return ((line.search(/^\s*\*/) >=0) ? true : false);
};

DocsParser.prototype.isNumeric = function(val) {
    if(!isNaN(val))
        return true;
...
DocsParser.prototype.formatVar = function(name, val, valType) {
...
DocsParser.prototype.getTypeInfo = function(argType, argName) {
    var typeInfo = '';
...
DocsParser.prototype.getFunctionReturnType = function(name, retval) {
...
DocsParser.prototype.parseArgs = function(args) {
    /*
...
DocsParser.prototype.getArgType = function(arg) {
    return null;
};

DocsParser.prototype.getArgName = function(arg) {
    return arg;
};

DocsParser.prototype.addExtraTags = function(out) {
...
DocsParser.prototype.guessTypeFromName = function(name) {
...
DocsParser.prototype.getMatchingNotations = function(name) {
...
DocsParser.prototype.getDefinition = function(editor, pos, readLine) {
    //TODO:
