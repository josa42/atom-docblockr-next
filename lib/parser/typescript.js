...
TypescriptParser.prototype.setupSettings = function() {
...
TypescriptParser.prototype.parseFunction = function(line) {
    line = line.trim();
...
TypescriptParser.prototype.getArgType = function(arg) {
    if(arg.indexOf(':') > -1) {
...
TypescriptParser.prototype.getArgName = function(arg) {
    if(arg.indexOf(':') > -1)
        arg = arg.split(':')[0];
...
TypescriptParser.prototype.parseVar = function(line) {
...
TypescriptParser.prototype.getFunctionReturnType = function(name, retval) {
    return ((retval != 'void') ? retval : null);
};

TypescriptParser.prototype.guessTypeFromValue = function(val) {
