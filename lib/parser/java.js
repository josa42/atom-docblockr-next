...
JavaParser.prototype.setupSettings = function() {
...
JavaParser.prototype.parseFunction = function(line) {
    line = line.trim();
    var regex = XRegExp(
        // Modifiers
...
JavaParser.prototype.parseVar = function(line) {
    return null;
};

JavaParser.prototype.guessTypeFromValue = function(val) {
    return null;
};

JavaParser.prototype.formatFunction = function(name, args, retval, throws_args, options) {
    options = (typeof options !== 'undefined') ? options : {};
    var out = DocsParser.prototype.formatFunction.call(this, name, args, retval, options);
    if(throws_args !== '') {
...
JavaParser.prototype.getFunctionReturnType = function(name, retval) {
    if(retval == 'void')
        return null;
    else
        return retval;
...
JavaParser.prototype.getDefinition = function(editor, pos, readLine) {
