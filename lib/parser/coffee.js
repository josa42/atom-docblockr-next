...
CoffeeParser.prototype.setupSettings = function() {
...
CoffeeParser.prototype.parseFunction = function(line) {
    var regex = XRegExp(
...
CoffeeParser.prototype.parseVar = function(line) {
    //   var foo = blah,
    //       foo = blah;
    //   baz.foo = blah;
    //   baz = {
...
CoffeeParser.prototype.guessTypeFromValue = function(val) {
