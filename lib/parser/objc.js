...
ObjCParser.prototype.setupSettings = function() {
...
ObjCParser.prototype.getDefinition = function(editor, pos, readLine) {
...
ObjCParser.prototype.parseFunction = function(line) {
...
ObjCParser.prototype.parseArgs = function(args) {
    var out = [];
...
ObjCParser.prototype.getFunctionReturnType = function(name, retval) {
...
ObjCParser.prototype.parseVar = function(line) {
    return null;
};
