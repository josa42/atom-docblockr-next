...
PhpParser.prototype.setupSettings = function() {
...
PhpParser.prototype.parseFunction = function(line) {
    var regex = XRegExp(
        'function\\s+&?(?:\\s+)?' +
...
PhpParser.prototype.getArgType = function(arg) {
    // function add($x, $y = 1)
    var regex = XRegExp(
...
PhpParser.prototype.getArgName = function(arg) {
...
PhpParser.prototype.parseVar = function(line) {
    /*
        var $foo = blah,
            $foo = blah;
        $baz->foo = blah;
...
PhpParser.prototype.guessTypeFromValue = function(val) {
...
PhpParser.prototype.getFunctionReturnType = function(name, retval) {
    var shortPrimitives = this.editor_settings.short_primitives || false;
    ...
    return DocsParser.prototype.getFunctionReturnType.call(this, name, retval);
};
